...
# ── In-memory store ──────────────────────────────────────────────────────────
tickets_db: dict = {}
counter = [6]  # mutable so nested functions can mutate it
...
SEED = [
    ...
    {"id": "INC0003", "title": "AC not working in Room 204",  "category": "Facilities", "priority": "Critical", "status": "Open",        "assignee": "Bob T.",   "created": "2025-05-12", "desc": "Air conditioning unit is completely offline. Room temp over 85°F."},
